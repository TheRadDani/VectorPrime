//! Runtime adapter registry and dispatch for VectorPrime.
//!
...
use vectorprime_core::{RuntimeAdapter, RuntimeKind};

/// Registry of all available runtime adapters.
///
/// On construction, all three built-in adapters are registered. Stubs return
/// [`vectorprime_core::RuntimeError::NotInstalled`] from `initialize` until their
